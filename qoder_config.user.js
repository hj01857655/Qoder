            ...
            <div style="margin-bottom: 20px;">
                <label style="display: block; margin-bottom: 8px; font-weight: 500; color: #333;">🔑 临时邮箱服务配置:</label>
                     ...
                     <div style="margin-bottom: 8px;">
                         <input type="text" id="tempmail" value="${(config.tempEmailConfig && config.tempEmailConfig.tempmail) || ''}" style="width: 100%; padding: 8px; border: 1px solid #ddd; border-radius: 4px; font-size: 14px;" placeholder="tempmail.plus 配置 (email+epin)">
                     </div>
                     <div style="margin-bottom: 8px;">
                         <input type="text" id="epin" value="${(config.tempEmailConfig && config.tempEmailConfig.epin) || ''}" style="width: 100%; padding: 8px; border: 1px solid #ddd; border-radius: 4px; font-size: 14px;" placeholder="epin 配置 (email+epin)">
                     </div>
                 </div>
