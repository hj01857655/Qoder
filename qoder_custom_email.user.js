// ==UserScript==
// @name         Qoder 注册助手 - 自定义邮箱版
// @namespace    http://tampermonkey.net/
// @version      1.0
// @description  在Qoder注册页面提供注册助手面板，支持自动注册功能（用户自定义邮箱）
// @author       hj0185765
// @match        https://qoder.com/*
// @match        https://*.qoder.com/*
// @grant        none
// @updateURL    https://raw.githubusercontent.com/hj01857655/Qoder/master/qoder_custom_email.user.js
// @downloadURL  https://raw.githubusercontent.com/hj01857655/Qoder/master/qoder_custom_email.user.js
// ==/UserScript==
...
(function () {
    ...
    function getUserEmail() {
        return new Promise((resolve) => {
            ...
            content.innerHTML = `
                <h3 style="margin: 0 0 20px 0; color: #333; text-align: center;">📧 请输入邮箱地址</h3>
                <div style="margin-bottom: 15px;">
                    <label style="display: block; margin-bottom: 5px; color: #666;">邮箱地址:</label>
                    <input type="email" id="email-input" placeholder="example@gmail.com" style="
                        width: 100%;
                        padding: 12px;
    ...
    function createRegisterPanel() {
        ...
        panel.innerHTML = `
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                <h3 style="margin: 0; color: #333; font-size: 18px;">🚀 Qoder 注册助手 - 自定义邮箱版</h3>
    ...
    async function startRegistration() {
        ...
        // 获取用户输入的邮箱
        addLog('📧 等待用户输入邮箱地址...', 'info');
        const userEmail = await getUserEmail();
        
        if (!userEmail) {
            addLog('❌ 用户取消邮箱输入', 'error');
